...
<div class="admin-biaogelist">
    ...
    <div class="fbneirong">
      <form class="am-form" action="{{url('attrtype/typeupd')}}" method="post">
      	{{csrf_field()}}
      	<input type="hidden" value="{{$type->type_id}}" name="type_id">
        <div class="am-form-group am-cf">
          <div class="zuo">类型名称:</div>
          <div class="you">
            <input type="text" name="type_name" class="am-input-sm" id="doc-ipt-email-1" value="{{$type->type_name}}" placeholder="请输入名称">
          </div>
        </div>
